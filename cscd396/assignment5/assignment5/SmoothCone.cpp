...
void Initialize(void) {
	...
	program_phong = initShaders("smoothshaderPong.vert", "smoothshaderPongfrag.frag");
	program_gouraud = initShaders("smoothshader.vert", "smoothshader.frag");
	if (switch_shader)
	...
	position_loc = glGetAttribLocation(program_current, "VertexPosition");
	glVertexAttribPointer(position_loc, 4, GL_FLOAT, GL_FALSE, 0, 0);
	glEnableVertexAttribArray(position_loc);

	normal_loc = glGetAttribLocation(program_current, "VertexNormal");
	...
	glUniform3fv(glGetUniformLocation(program_current, "Material.Ka"), 1, (GLfloat*)&material_ambient);
	glUniform3fv(glGetUniformLocation(program_current, "Material.Kd"), 1, (GLfloat*)&material_diffuse);
	glUniform3fv(glGetUniformLocation(program_current, "Material.Ks"), 1, (GLfloat*)&material_specular);
	glUniform1f(glGetUniformLocation(program_current, "Material.Shininess"), material_shininess);

	glUniform3fv(glGetUniformLocation(program_current, "Light.La"), 1, (GLfloat*)&light_ambient);
	glUniform3fv(glGetUniformLocation(program_current, "Light.Ld"), 1, (GLfloat*)&light_diffuse);
	glUniform3fv(glGetUniformLocation(program_current, "Light.Ls"), 1, (GLfloat*)&light_specular);
...
void Display(void)
{
	...
	glUniform4fv(glGetUniformLocation(program_current, "Light.Position"), 1, (GLfloat*)&lightpos);
	...
	glUniformMatrix4fv(glGetUniformLocation(program_current, "MVP"), 1, GL_FALSE, (GLfloat*)&mvp[0]);
	glUniformMatrix4fv(glGetUniformLocation(program_current, "ProjectionMatrix"), 1, GL_FALSE, (GLfloat*)&projection[0]);

	glUniformMatrix4fv(glGetUniformLocation(program_current, "ModelViewMatrix"), 1, GL_FALSE, (GLfloat*)&ModelView[0]);
	...
	glUniformMatrix3fv(glGetUniformLocation(program_current, "NormalMatrix"), 1, GL_FALSE, (GLfloat*)&Normal[0]);
